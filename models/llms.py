...
completion_fns = {
    "gpt35_00": partial(gpt_completion_fn, model="gpt35_00"),
    "gpt4_00": partial(gpt_completion_fn, model="gpt4_00"),
    ...
    "gpt-3.5-turbo-instruct": partial(
        gpt_completion_fn, model="gpt-3.5-turbo-instruct"
    ),
